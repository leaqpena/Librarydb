...
@section('content')
<title>Dashboard -LIBRARY DB</title>
              ...
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="{{ route('books.index')}}" class="menu-link">
                    <div class="text-truncate" data-i18n="Analytics">BOOKS</div>
                  </a>
                </li>
        ...
        <div class="col-xxl-8 mb-6 order-0">
            <div class="card">
                <div class="d-flex align-items-start row">
                  <div class="col-sm-7">
                    <div class="card-body">
                      <h5 class="card-title text-primary mb-3">WELCOME !! <br>{{ auth()->user()->name }} 🎉</h5>
                    </div>
                  </div>
